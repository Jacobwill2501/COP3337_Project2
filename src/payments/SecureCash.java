...
System.out.println("//////////////////////////////////////////////");  
        ...
        // 3890 <- final pin
         ...
         //YOUR CODE HERE
         String broughtLastName = getPerson().getLastName();
         broughtLastName = broughtLastName.toLowerCase();
         int num1 = ((broughtLastName.charAt(0))-96)%10;
         int num2 = ((broughtLastName.charAt(1))-96)%10;
         int num3 = ((broughtLastName.charAt(2))-96)%10;
         int num4 = ((broughtLastName.charAt(3))-96)%10;
         
         pin = pin + num1 + num2 + num3 + num4;
